...
@Service
public class EmployerMoletDeleteService implements AbstractDeleteService<Employer, Molet> {
	...
	@Override
	public void delete(final Request<Molet> request, final Molet entity) {
